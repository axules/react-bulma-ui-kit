...
function renderEach(cases, props = {}) {
  return cases.map(it => (0,docsSrc_utils/* prepareSample */.ws)(components_Tag, {
    key: it,
    children: it || 'Default',
    ...(it ? {
      [it]: true
...
const examples = {
  ...
  Tags: (() => {
    const R1 = /*#__PURE__*/(0,jsx_runtime.jsxs)(components_Tags, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(components_Tag, {
        primary: true,
        children: "today"
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(components_Tag, {
        warning: true,
        children: "tomorrow"
      })]
    });
